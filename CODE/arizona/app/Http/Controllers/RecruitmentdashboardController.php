...
class RecruitmentdashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $list ="";
        return view('hrmodule.recruitmentdashboard')->with([
    ...
    public function screening()
    {
        ...
        $master = $this->getmasterfields();
        $list ="";
        return view('hrmodule.screening')->with([
            'result' => $this->getResult(),
            'pageTitle' => "Dashboard page",
            'master' => $master,
        ]);
    ...
    */
    ...
    public static function routes()
    {
            ...
            Route::get('/dashboard', array('as' => 'recruitment.index', 'uses' => 'RecruitmentdashboardController@index'));
            Route::get('/screening', array('as' => 'recruitment.screening', 'uses' => 'RecruitmentdashboardController@screening'));
