									 ...
									 <thead>
									  <tr>
                                        ...
                                        @foreach($listData as $list)
											...
											<td class="datainner" style="">{{$list->exit_type_id}}</td>
											...
											<td align="right">
													<div class="dropdown action-drop">
														...
														<ul class="dropdown-menu">
															...
															<li><a href="{{url('/employeesexit/delete/')}}/{{$list->id}}" onclick="return confirm('Are you sure to want delete this?')"><i class="fa fa-times"></i>Delete Record</a></li>
														</ul>
													</div>
												</td>                     
