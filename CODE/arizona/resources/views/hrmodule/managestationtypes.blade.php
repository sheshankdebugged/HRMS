               ...
               <div class="request-inner-table">
                     ...
                     <div class="col-md-12 nopadding">
                        ...
                        <div class="col-md-8 nopadding">
                           <div class="filter-btn-request">
                              <a href="managestationtypes" alt="Dashboard"><i class="fa fa-refresh"></i></a>
                           </div>
                  ...
                  <div class="form-subsets">
                     <div id="addskills" class="text-center" style="display:none;">
                        <form method="post" action="{{ url('managestationtypes/save') }}">
                           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <input type="hidden" name="id" value="{{isset($result->id)?$result->id:''}}">
                           <div class="form-field-inner">
                              <div class="form-group">
                                 <input type="text" class="form-control-spacial" placeholder="New Record Value" id="station_type_name" name="station_type_name" value="{{isset($result->station_type_name)?$result->station_type_name:''}}">
                              </div>
                              <div class="form-group">
                           ...
                           <table id="requesttab" border="0" cellspacing="0" cellpadding="3" width="100%" align="center">
                              ...
                              <tbody>
                                 ...
                                 <tr id="second" class="context-requst-one selected">
                                    ...
                                    <td class="datainner" style="">{{$list->station_type_name}}</td>
                                    <td class="datainner" style=""> </td>
                                    <td align="right">
                                       <a href="{{url('/managestationtypes/delete/')}}/{{$list->id}}" onclick="return confirm('Are you sure to want delete this?')"><i class="fa fa-times"></i></a>
                                    </td>
                                 </tr>
                                 @php $i++; @endphp
                                 @endforeach
