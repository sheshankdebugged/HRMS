								...
								<div class="upper-header-request">
								 ...
								 <form id="search" name="search" method="get" />
											...
											<div class="filter-btn-request">
												...
												<a href="projects" alt="Dashboard"><i class="fa fa-refresh"></i></a>
											</div>
												...
												<td align="right">
													<div class="dropdown action-drop">
														...
														<ul class="dropdown-menu">
															...
															<li><a href="{{url('/projects/delete/')}}/{{$list->id}}" onclick="return confirm('Are you sure to want delete this?')"><i class="fa fa-times"></i>Delete Record</a></li>
														</ul>
													</div>
												</td>
											</tr>
