							...
							<div class="request-inner-table">
								<div class="upper-header-request">
                             	...
                             	<div class="col-md-8 nopadding">
								 		<div class="add-record-btn">
												<a href="{{ url('employeegrades/add') }}"><i class="fa fa-plus"></i>Add Employee Grades</a>
											</div>
											<div class="add-record-btn">
								...
								<div class="inner-table-main" style="min-height:590px;">
									<table id="requesttab" border="0" cellspacing="0" cellpadding="3" width="100%" align="center">
									 <thead>
									  <tr>
										  <td style="background-color:#0c64ae; " class="thbackgroud"><a style="color:#fff; " href="#">	Grade Name</a></td>
											...
											<td align="right">
												<div class="dropdown action-drop">
													...
													<ul class="dropdown-menu">
														...
														<li><a href="{{url('/employeegrades/edit')}}/{{$list->id}}"><i class="fa fa-edit"></i>Edit Record</a></li>
														<!-- <li><a href="#"><i class="fa fa-sticky-note"></i>Notes</a></li> -->
														<li><a href="{{url('/employeegrades/delete/')}}/{{$list->id}}" onclick="return confirm('Are you sure to want delete this?')"><i class="fa fa-times"></i>Delete Record</a></li>
													</ul>
												</div>
											</td> 
										</tr>
