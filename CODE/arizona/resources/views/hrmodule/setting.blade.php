        ...
        <div class="inner-org">
          ...
          <div class="form-field-an">
            ...
            <div class="field-group">
              ...
              <div class="field-value-an">
                <input type="text" name="o_name" placeholder="WebHR Demo" value="">
              </div>
            </div>
            <div class="field-group">
              <div class="file-title-an">
              ...
              <div class="field-value-an">
                <input type="text" name="o_year" placeholder="2007" value="">
              </div>
            </div>
          ...
          <div class="form-field-an">
            ...
            <div class="field-group">
                  ...
                  <div class="field-value-an">
                    <input type="text" name="o_year" placeholder="+1-801-901-0090" value="">
                  </div>
                </div>
            ...
            <div class="field-group">
              ...
              <div class="field-value-an">
                <select>
                  ...
                  <option>(GMT-1:00) International Date Line West</option>
                  <option>(GMT-2:00) International Date Line West</option>
                </select>
              </div>
            </div>
            <div class="field-group">
              ...
              <div class="field-value-an">
                <select>
                  <option>December 26, 2018</option>
                  <option>Wednesday, December 26, 2018</option>
                  <option>12/26/2018 (MM/DD/YYYY)</option>
                </select>
              </div>
            </div>
            <div class="field-group">
          ...
          <div class="inner-wrapper-an">
            <div class="custon-field-header">
              ...
              <div class="right-button">
                      ...
                      </div><div class="search-area-request">
