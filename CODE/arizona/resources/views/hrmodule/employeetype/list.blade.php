								...
								<div class="upper-header-request">
                             	...
                             	<div class="col-md-8 nopadding">
								 		<div class="add-record-btn">
												<a href="{{ url('employeetype/add') }}"><i class="fa fa-plus"></i>Add records</a>
											</div>
											<div class="add-record-btn">
											...
											<td align="right">
												<div class="dropdown action-drop">
													...
													<ul class="dropdown-menu">
														...
														<li><a href="{{url('/employeetype/edit')}}/{{$list->id}}"><i class="fa fa-edit"></i>Edit Record</a></li>
														<!-- <li><a href="#"><i class="fa fa-sticky-note"></i>Notes</a></li> -->
														<li><a href="{{url('/employeetype/delete/')}}/{{$list->id}}" onclick="return confirm('Are you sure to want delete this?')"><i class="fa fa-times"></i>Delete Record</a></li>
													</ul>
												</div>
											</td> 
										</tr>
