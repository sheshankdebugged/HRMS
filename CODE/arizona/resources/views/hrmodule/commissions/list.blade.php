								...
								<div class="upper-header-request">
								 ...
								 <form id="search" name="search" method="get" />
											...
											<div class="filter-btn-request">
												...
												<a href="{{ url('commissions') }}" alt="Dashboard"><i class="fa fa-refresh"></i></a>
											</div>
											<div class="add-record-btn">
												<a href="{{ url('commissions/add') }}"><i class="fa fa-plus"></i>Add Record</a>
											</div>
											<div class="add-record-btn">
												<a href="{{ url('commissions/adds') }}">Add Multiple Commissions</a>
											</div>
										</div>
									 ...
									 <thead>
									  <tr>
                                        ...
                                        @foreach($listData as $list)
											...
											<td class="datainner" style="">{{$list->commissions_title}}</td>
											<td class="datainner" style="">{{$list->commissions_amount}}</td>  
											<td class="datainner" style="">{{$list->commissions_date}}</td>
											...
											<td align ="right">
												<div class="dropdown action-drop">
													...
													<ul class="dropdown-menu">
														...
														<li><a href="{{url('/commissions/edit')}}/{{$list->id}}"><i class="fa fa-edit"></i>Edit Record</a></li>
														<!-- <li><a href="#"><i class="fa fa-sticky-note"></i>Notes</a></li> -->
														<li><a href="{{url('/commissions/delete/')}}/{{$list->id}}" onclick="return confirm('Are you sure to want delete this?')"><i class="fa fa-times"></i>Delete Record</a></li>
													</ul>
												</div>
											</td> 
										</tr>
