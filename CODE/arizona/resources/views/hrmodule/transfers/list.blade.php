								...
								<div class="upper-header-request">
								 ...
								 <form id="search" name="search" method="get" />
											...
											<div class="filter-btn-request">
												...
												<a href="{{ url('transfers') }}" alt="Dashboard"><i class="fa fa-refresh"></i></a>
											</div>
											<div class="add-record-btn">
												<a href="{{ url('transfers/add') }}"><i class="fa fa-plus"></i>Add Record</a>
											</div>
									...
									<table id="requesttab" border="0" cellspacing="0" cellpadding="3" width="100%" align="center">
									 <thead>
									  <tr>
										  ...
										  <td style="background-color:#0c64ae; " class=""><a style="color:#fff; " href="#">	Transfer Date</a></td>
										  <td style="background-color:#0c64ae; " class=""><a style="color:#fff; " href="#">Transfer To (Department)</a></td>
										  <td style="background-color:#0c64ae; " class=""><a style="color:#fff; " href="#">Transfer To (Station)</a></td>
                                        ...
                                        @foreach($listData as $list)
											...
											<td class="datainner" style="">{{$list->transfer_date}}</td>
											<td class="datainner" style="">{{$list->transfer_to_department}}</td> 
											<td class="datainner" style="">{{$list->transfer_to_station}}</td> 
											...
											<td align="right">
												<div class="dropdown action-drop">
													...
													<ul class="dropdown-menu">
														...
														<li><a href="{{url('/transfers/delete/')}}/{{$list->id}}" onclick="return confirm('Are you sure to want delete this?')"><i class="fa fa-times"></i>Delete Record</a></li>
													</ul>
												</div>
											</td> 
										</tr>
