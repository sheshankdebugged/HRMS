								...
								<div class="upper-header-request">
								 ...
								 <form id="search" name="search" method="get">
											...
											<div class="filter-btn-request">
												...
												<a href="{{ url('insurance') }}" alt="Dashboard"><i class="fa fa-refresh"></i></a>
											</div>
											<div class="add-record-btn">
												<a href="{{ url('insurance/add') }}"><i class="fa fa-plus"></i>Add Record</a>
											</div>
									...
									<table id="requesttab" border="0" cellspacing="0" cellpadding="3" width="100%" align="center">
									 <thead>
									  <tr>
										  ...
										  <td style="background-color:#0c64ae; " class=""><a style="color:#fff; " href="#">Insurance Title</a></td>
										  <td style="background-color:#0c64ae; " class=""><a style="color:#fff; " href="#">Employee Share</a></td>
										  <td style="background-color:#0c64ae; " class="thbackgroud"><a style="color:#fff; " href="#">Organization Share</a></td>
										  <td style="background-color:#0c64ae; " class="thbackgroud"><a style="color:#fff; " href="#">Expiry Date</a></td>
											...
											<td align="right">
													<div class="dropdown action-drop">
														...
														<ul class="dropdown-menu">
															...
															<li><a href="{{url('/insurance/edit')}}/{{$list->id}}"><i class="fa fa-edit"></i>Edit Record</a></li>
															...
															<li><a href="{{url('/insurance/delete/')}}/{{$list->id}}" onclick="return confirm('Are you sure to want delete this?')"><i class="fa fa-times"></i>Delete Record</a></li>
														</ul>
													</div>
												</td>                     
